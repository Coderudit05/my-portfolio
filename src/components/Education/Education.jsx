...
function Education() {
  ...
  const educationData = [
    {
      ...
      side: "left",
      marksheet: "./my docs/Udit's Marksheet of Graduation.pdf",
    },
    {
      id: 2,
      ...
      side: "right",
      marksheet: "./my docs/udit's 10_and_12th_marksheet.pdf",
    },
    {
      id: 3,
  ...
  return (
    <section className="min-h-screen bg-black text-white py-20 px-8 relative overflow-hidden">
      {/* =============================
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-yellow-400/80 z-10"></div>
        ...
        {educationData.map((edu) => (
          <div key={edu.id} className="relative">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 top-1/2 z-10">
              <div className="w-6 h-6 bg-yellow-400 rounded-full border-4 border-black shadow-lg shadow-yellow-400/40 animate-pulse"></div>
            </div>
            ...
            >
              <div
                className={`w-full md:w-5/12 bg-[#181818] border border-yellow-500/40 rounded-xl p-6 hover:border-yellow-400 transition-all duration-300 hover:shadow-lg hover:shadow-yellow-400/20 ${
              ...
              >
                ...
                <p
                  className={`text-sm text-yellow-300 mb-4 flex items-center gap-2 ${
                ...
                >
                  <a
                    href={edu.marksheet}
                    download
                    className="border border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black px-5 py-2 rounded-lg font-medium transition duration-300"
                  >
                    Download Marksheet
                  </a>
                </div>
