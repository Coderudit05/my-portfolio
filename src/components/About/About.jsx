...
function About() {
  return (
    <section className="relative p-14 flex items-center justify-center overflow-hidden min-h-screen">
      ...
      <div className="relative max-w-8xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center h-full z-10">
        {/* Left Side - Text Content */}
        <div className="text-left animate-[fadeInLeft_1s_ease-out] ">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white animate-[fadeInDown_0.8s_ease-out]">
            <TypeAnimation
              sequence={[
                "Hi, I'm Udit Namdev",
                2000,
          ...
          <p className="text-lg text-gray-300 mb-6 leading-relaxed animate-[fadeInUp_1s_ease-out_0.3s_backwards]">
          ...
          <p className="text-lg text-gray-300 mb-8 leading-relaxed animate-[fadeInUp_1s_ease-out_0.5s_backwards]">
          ...
          <div className="flex gap-4 flex-wrap animate-[fadeInUp_1s_ease-out_0.7s_backwards]">
            ...
            <a
              ...
              download
              className="border border-gradient-to-r from-blue-400 to-purple-500 text-blue-400 hover:text-white hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 px-6 py-3 rounded-lg font-semibold transition duration-300"
            >
              Get My Resume
            </a>
          </div>
          ...
          {/* Social Media Icons */}
          <div className="flex items-center gap-6 mt-8 animate-[fadeInUp_1s_ease-out_0.9s_backwards]">
            {/* LinkedIn */}
            <a
        ...
        <div className="flex justify-center items-center animate-[fadeInRight_1s_ease-out]">
          <div className="relative w-auto h-auto md:96 md:h-96 group">
            ...
            <div className="relative w-full h-full rounded-2xl overflow-hidden p-1 group-hover:scale-105 transition-transform duration-500">
              <img
                src={myPicture}
                alt="Udit Namdev"
                className="w-full h-full rounded-xl group-hover:brightness-110 transition-all duration-500"
              />
            </div>
          </div>
        </div>
